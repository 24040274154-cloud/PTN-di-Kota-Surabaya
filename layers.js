...
lyr_aksesibilitasuniversitas_1.set('fieldLabels', {'fid': 'hidden field', 'Access': 'hidden field', });
lyr_PTNdiSurabaya_2.set('fieldLabels', {'fid': 'hidden field', 'Nama': 'hidden field', 'Kampus': 'inline label - always visible', 'FOTO': 'no label', 'Tahun Berdiri': 'inline label - always visible', 'Fakultas': 'inline label - always visible', 'Rangking QS WUR': 'inline label - always visible', });
